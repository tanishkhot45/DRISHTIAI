      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <p className="text-xs text-muted">
            Found <span className="text-fg font-medium">{extracted.length}</span>{" "}
              ...
              <li key={i}>
                <button
                  ...
                  className={[
                    ...
                    isOn
                      ? "bg-accent/10"
                      : "bg-transparent hover:bg-fg/[0.03]",
                  ].join(" ")}
                >
                  <span
                    className={[
        ...
        <div className="flex justify-end">
          ...
          >
            <Plus className="h-3.5 w-3.5" />
            Add {selected.size} {selected.size === 1 ? "component" : "components"}
          </Button>
        </div>
      </div>
    );
...
Flowline spool, 1, 10ft`}
      ...
      <div className="flex items-center justify-between">
        <p className="text-[11px] text-subtle">
          {parsed.length > 0
            ? `Ready to add ${parsed.length} component${parsed.length === 1 ? "" : "s"}.`
