...
<svg viewBox="0 0 24 24" className="relative z-10 h-5 w-5 text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)] dark:text-black dark:drop-shadow-none" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">    <path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7z" />
    <circle cx="12" cy="12" r="3" fill="currentColor" fillOpacity="0.25" />
        ...
        <nav className="flex items-center gap-2">
          <Link
            href="/setup"
            className="hidden rounded-full px-3 py-1.5 text-sm text-muted transition hover:text-fg sm:inline-flex"
          >
            Select
          </Link>
          <Link
